  ...
  function consentScreen(el, taskLabel, minutes, onOk, headphone, opts) {
    ...
    el.innerHTML = `
      ...
      <ul style="font-size:14px;line-height:1.9;color:#333">
        ...
        ${resumeAware ? `<li><b>途中再開の記録</b>：中断した場合に再開するための記録は、お使いのブラウザ内にのみ保存されます（研究者には送信されません）。</li>` : ""}
        <li><b>回答のしかた</b>：回答の正誤によって報酬が変わることはありません。判別しにくい問題も含まれますので、分からない場合も、もっとも近いと思う文字を選んでください。</li>

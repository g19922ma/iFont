  ...
  function consentScreen(el, taskLabel, minutes, onOk, headphone, opts) {
    ...
    el.innerHTML = `
      ...
      <ul style="font-size:14px;line-height:1.9;color:#333">
        ...
        ${resumeAware ? `<li><b>途中再開の記録</b>：中断した場合に再開するための記録は、お使いのブラウザ内にのみ保存されます。再開した回数と中断時間は、回答データとともに記録されます。</li>` : ""}
        <li><b>報酬</b>：回答の正誤によって報酬が変わることはありません。ただし、課題に取り組んでいないと判断される回答が続いた場合は、報酬の対象外となることがあります。</li>
